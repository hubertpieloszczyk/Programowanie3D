...
void SimpleShapeApplication::init() {
    ...
    camera_->look_at(glm::vec3{0.0,3.0,0.0},glm::vec3{0.0,0.0,0.0},glm::vec3{0.0,1.0,1.0});
...
void SimpleShapeApplication::frame() {
    ...
    glBindBuffer(GL_UNIFORM_BUFFER, u_light_buffer_);
    glBufferSubData(GL_UNIFORM_BUFFER, 0 * sizeof(glm::vec4), sizeof(glm::vec4), &light.position);
    glBufferSubData(GL_UNIFORM_BUFFER, 1 * sizeof(glm::vec4), sizeof(glm::vec4), &light.color);
    ...
    quad->draw(P,VM,N,u_pvm_buffer_);
}
